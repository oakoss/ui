...
2. Comment to claim, assign yourself, and move the issue's board Status to In Progress
...
- Mark the PR ready for review (out of draft) and move the issue's board Status to In Review
